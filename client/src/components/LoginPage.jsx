        ...
        <div className="w-screen h-screen flex justify-center items-center">
          ...
          <div className=" bg-white m-4 p-10 rounded-3xl shadow overflow-hidden drop-shadow-lg ">
            <div className="flex justify-center items-center flex-col">
              <h3 className="pb-6 font-medium drop-shadow-lg text-xl text-[#161C2D]">
                Welcome to FanousPROD
              </h3>
              <div className="bg-[#F1DBC0]  h-14 xl:w-80 2xl:w-80 md:w-80 sm:w-80 lg:w-80 w-72 rounded-full p-2.5 flex flex-row justify-between">
                ...
                <button className="rounded-full border-[#6F584C] pr-12 text-[#6F584C] ">
                  Register
                </button>
              </div>
            </div>
            ...
            <form onSubmit={onSubmit}>
              ...
              <div className=" py-8 ">
                ...
                <div className="flex flex-col">
                  <label className="pb-2 drop-shadow-lg text-[#161C2D]">
                    Email Address
                  </label>
                  <input
                    type="email"
                ...
                <div className="flex flex-col pt-3">
                  ...
                  <div className="relative">
                    ...
                    >
                      {showPassword ? (
                        <FaEye style={{ color: "#787676" }} />
                      ) : (
                        <FaEyeSlash style={{ color: "#787676" }} />
                      )}
                    </button>
                  </div>
                </div>
                ...
                <div className="p-2 flex justify-between">
                  <div>
                    ...
                    />
                    <label className="text-[#161C2D] drop-shadow-md ml-2">
                      Remember Me
                    </label>
                  </div>
                  <label className="text-[#161C2D] ml-2 drop-shadow-md hover:underline hover:cursor-pointer">
                    Forgot Password?
                  </label>
                </div>
              </div>
              ...
              <div className="flex justify-center">
                <button
                  type="submit"
                  className="bg-[#6F584C]  rounded-full w-40 h-10 text-[#F1DBC0] hover:bg-[#F1DBC0] hover:text-[#6F584C] "
                >
                  Login
                </button>
              </div>
              ...
              <div className="pt-7 flex flex-col  items-center">
                ...
                <div className="flex flex-row items-center gap-6 justify-center">
                  ...
                  />
                  <IoLogoApple
                    className="w-10 h-10 hover:cursor-pointer mb-1.5"
                    style={{ color: "#161C2D" }}
                  />
                </div>
              </div>
