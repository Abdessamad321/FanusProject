        ...
        <div className='w-screen h-screen flex justify-center items-center'>
          ...
          <div className="absolute h-full w-full insets-0 flex justify-between">
            ...
            <div className=" bg-white w-1/2 p-2 flex justify-end">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 cursor-pointer ">
                <path strokeLinecap="round" strokeLinejoin="round" d="M6 18 18 6M6 6l12 12" style={{ color: '#161C2D' }} />
              </svg>
            </div>
          </div>
          {/* form            */}
          <div className=" bg-white m-4 p-10 rounded-3xl shadow overflow-hidden drop-shadow-lg ">
            <div className="flex justify-center items-center flex-col">
              <h3 className="pb-6 font-medium drop-shadow-lg text-xl text-[#161C2D]">Welcome to FanousPROD</h3>
            ...
            <form onSubmit={onSubmit} >
              ...
              <div className=" py-8 ">
                ...
                <div className="flex flex-col">
                  <label className="pb-2 drop-shadow-lg text-[#161C2D]">Email Address</label>
                  <input
                    type="email"
                ...
                <div className="flex flex-col pt-3">
                  <label className="pb-2 drop-shadow-lg text-[#161C2D]">Password</label>
                ...
                <div className="p-2 flex justify-between">
                  <div>
                    ...
                    <label className="text-[#161C2D] drop-shadow-md ml-2">Remember Me</label>
                  </div>
                  <label className="text-[#161C2D] ml-2 drop-shadow-md hover:underline hover:cursor-pointer">Forgot Password?</label>
                </div>
              </div>
              ...
              <div className="pt-7 flex flex-col  items-center">
                ...
                <div className="flex flex-row items-center gap-6 justify-center">
                  <BsFacebook className="w-9 h-9 hover:cursor-pointer" style={{ color: '#161C2D' }}  />
                  <IoLogoGoogle className="w-9 h-9 hover:cursor-pointer " style={{ color: '#161C2D' }} />
                  <IoLogoApple className="w-10 h-10 hover:cursor-pointer mb-1.5" style={{ color: '#161C2D' }} />
                </div>
