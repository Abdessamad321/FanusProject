...
export default function Home() {
  ...
  const slideLeft = (n) => {
    ...
    if (typeof n === "number") slider.scrollLeft = n;
    else slider.scrollLeft -= VALUE_TO_SLIDE;
...
const fetchEvent = async () =>{
  ...
  const navigateToProductDetail = (eventId) => {
...
//                 onClick={() => navigateToProductDetail(event._id)}
              ...
              >
                <img
                  src={test}
                  alt="/"
                  className="2xl:h-72 h-80 w-full rounded-lg cursor-pointer"
                />
              ...
              <div className="p-2 ">
                ...
                <div className="flex justify-between">
                  ...
                  {/* button */}
                  <button className="bg-[#6F584C] font-bold rounded-lg w-28 h-8 text-[#F5EFEC] hover:border-2 hover:border-[#6F584C] hover:bg-[#F5EFEC] hover:text-[#6F584C] ">
                    Add to cart
                  </button>
                </div>
              </div>
      ...
      <div className="2xl:px-40 xl:px-72 lg:px-40">
        {/* first part */}
        <h1 className="text-[#161C2D] text-3xl font-extrabold text-center p-10">
          Reserve your seat with 3 easy steps
        </h1>
        <h1 className="text-[#6c6969] text-lg font-medium text-center ">
          {" "}
          Start transforming your vision into a remarkable reality today!
        </h1>
          ...
          <div className="relative">
            ...
            <div className="absolute h-16 w-60 bg-white rounded-lg bottom-16 -left-8 flex items-center">
              ...
              <div>
                ...
                <h1 className="text-[#161C2D] text-lg font-semibold">
                  Reservation done!
                </h1>
              </div>
            </div>
          ...
          <div className=" flex flex-col gap-y-7 m-4">
            ...
            <div className="flex gap-5">
              <div className="bg-[#6F584C] w-10 h-10 rounded-full flex items-center justify-center">
                <h1 className="text-center font-extrabold text-[#F5EFEC] mx-4 text-xl">
                  1
                </h1>
              </div>
              <div>
                <h1 className="text-[#161C2D] text-2xl font-bold pb-2">
                  Browse Events
                </h1>
                <h1 className="text-[#6c6969] text-lg font-medium">
                  Discover diverse shows from concerts to festivals, find the
                  perfect experience.
                </h1>
              </div>
            </div>
            ...
            <div className="flex gap-5">
              <div className="bg-[#6F584C] w-10 h-10 rounded-full flex items-center justify-center">
                <h1 className="text-center text-xl font-extrabold text-[#F5EFEC] mx-4">
                  2
                </h1>
              </div>
              <div>
                ...
                <h1 className="text-[#6c6969] text-lg font-medium">
                  Easily select your preferred spot on our interactive venue
                  layout.
                </h1>
              </div>
            </div>
            ...
            <div className="flex gap-5">
              ...
              <div>
                ...
                <h1 className="text-[#6c6969] text-lg font-medium">
                  Hassle-free ticket purchase for an elevated event experience!
                </h1>
              </div>
            </div>
          </div>
        ...
        <div className="flex text-center 2xl:text-start xl:text-start lg:text-start md:text-start flex-col md:flex-row 2xl:flex-row xl:flex-row lg:flex-row justify-around border-t-2 p-6">
          <div>
            <h1 className="text-[#161C2D] text-2xl font-bold pb-5">
              Ready to find your perfect Event?
            </h1>
            <h1 className="text-[#6c6969] text-lg font-medium pb-5">
              Let the discovery begin, find your unforgettable experience now!
            </h1>
          </div>
          <div className="pt-2">
            <button className="bg-[#6F584C] font-medium rounded-lg w-48 h-10 text-[#F5EFEC] hover:border-2 hover:border-[#6F584C] hover:bg-[#F5EFEC] hover:text-[#6F584C]">
              Begin Discovery
            </button>
          </div>
        </div>
...
//         </h1>
        ...
        <div className="flex flex-col gap-y-14 my-10 2xl:flex-row xl:flex-row lg:flex-row">
          <div className=" m-2 flex gap-6 2xl:w-1/3 xl:w-1/3 lg:w-1/3">
            ...
            <div>
              <h1 className="text-[#161C2D] text-2xl font-bold pb-2">
                Easy allocated seating
              </h1>
              <p className="text-[#6c6969] text-lg font-sm">
                Choose your preferred seats directly, secure tickets for your
                favorite artists.
              </p>
            </div>
          </div>
          ...
          <div className=" m-2 flex gap-6 2xl:w-1/3 xl:w-1/3 lg:w-1/3">
            ...
            <div>
              ...
              <p className="text-[#6c6969] text-lg font-sm">
                Stay connected to your attendees with advanced email marketing
                tools, targeted notifications.
              </p>
            </div>
          </div>
          ...
          <div className=" m-2 flex gap-6 2xl:w-1/3 xl:w-1/3 lg:w-1/3">
            ...
            <div>
              ...
              <p className="text-[#6c6969] text-lg font-sm">
                Plan and organize your next event, with an array of innovative
      ...
      <div className=" flex flex-col border-b-2 py-8 px-3">
        ...
        >
          {data.map((item, i) => (
            <div
              key={`card-sroll-${i}`}
              className="p-2 relative 2xl:p-4 xl:p-4  lg:p-4  md:p-4 w-1/2 2xl:w-1/4 xl:w-1/4 lg:w-1/4 md:w-1/4 inline-block cursor-pointer  hover:scale-105 ease-in-out duration-300"
            >
          ...
          {data.slice(0, data.length - 3).map((item, i) => (
            <TbPointFilled
              ...
              style={{
                opacity:
                  1 -
                  Math.abs(scrollValue - i * VALUE_TO_SLIDE) /
                    ((data.length - 3) * VALUE_TO_SLIDE),
              }}
